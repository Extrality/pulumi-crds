 ...
 */
export class EphemeralRunnerSetList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EphemeralRunnerSetList {
        return new EphemeralRunnerSetList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:actions.github.com/v1alpha1:EphemeralRunnerSetList';

    /**
     * Returns true if the given object is an instance of EphemeralRunnerSetList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EphemeralRunnerSetList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EphemeralRunnerSetList.__pulumiType;
    }
     ...
     */
    declare public readonly items: pulumi.Output<outputs.actions.v1alpha1.EphemeralRunnerSet[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"EphemeralRunnerSetList">;
    /**
    ...
    constructor(name: string, args?: EphemeralRunnerSetListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "EphemeralRunnerSetList";
        ...
        super(EphemeralRunnerSetList.__pulumiType, name, resourceInputs, opts);
    }
}
