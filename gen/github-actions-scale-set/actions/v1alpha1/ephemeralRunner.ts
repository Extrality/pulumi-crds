...
export class EphemeralRunner extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.actions.v1alpha1.EphemeralRunnerSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.actions.v1alpha1.EphemeralRunnerStatus>;
