...
export class EphemeralRunner extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.actions.v1alpha1.EphemeralRunnerSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.actions.v1alpha1.EphemeralRunnerStatus>;
