 ...
 */
export declare class EphemeralRunner extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EphemeralRunner;
    /**
     * Returns true if the given object is an instance of EphemeralRunner.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EphemeralRunner;
    /**
    ...
    readonly spec: pulumi.Output<outputs.actions.v1alpha1.EphemeralRunnerSpec>;
    readonly status: pulumi.Output<outputs.actions.v1alpha1.EphemeralRunnerStatus>;
    /**
...
export interface EphemeralRunnerArgs {
    ...
    spec?: pulumi.Input<inputs.actions.v1alpha1.EphemeralRunnerSpec | undefined>;
}
//# sourceMappingURL=ephemeralRunner.d.ts.map