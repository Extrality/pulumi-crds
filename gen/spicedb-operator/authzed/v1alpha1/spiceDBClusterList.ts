 ...
 */
export class SpiceDBClusterList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SpiceDBClusterList {
        return new SpiceDBClusterList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:authzed.com/v1alpha1:SpiceDBClusterList';

    /**
     * Returns true if the given object is an instance of SpiceDBClusterList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SpiceDBClusterList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SpiceDBClusterList.__pulumiType;
    }
     ...
     */
    public readonly items!: pulumi.Output<outputs.authzed.v1alpha1.SpiceDBCluster[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    public readonly kind!: pulumi.Output<"SpiceDBClusterList">;
    /**
    ...
    constructor(name: string, args?: SpiceDBClusterListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "SpiceDBClusterList";
        ...
        super(SpiceDBClusterList.__pulumiType, name, resourceInputs, opts);
    }
}
