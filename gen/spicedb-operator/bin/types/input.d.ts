...
export declare namespace authzed {
    namespace v1alpha1 {
        ...
        interface SpiceDBCluster {
            ...
            status?: pulumi.Input<inputs.authzed.v1alpha1.SpiceDBClusterStatus>;
        }
        /**
        ...
        interface SpiceDBClusterSpec {
             ...
             */
            patches?: pulumi.Input<pulumi.Input<inputs.authzed.v1alpha1.SpiceDBClusterSpecPatches>[]>;
            /**
        ...
        interface SpiceDBClusterSpecPatch {
             ...
             * in the list take precedence over earlier ones.
             */
            patches?: pulumi.Input<pulumi.Input<inputs.authzed.v1alpha1.SpiceDBClusterSpecPatchesPatch>[]>;
            /**
             * SecretName points to a secret (in the same namespace) that holds secret
             * config for the cluster like passwords, credentials, etc.
             * If the secret is omitted, one will be generated
        ...
        interface SpiceDBClusterStatus {
             ...
             */
            availableVersions?: pulumi.Input<pulumi.Input<inputs.authzed.v1alpha1.SpiceDBClusterStatusAvailableVersions>[]>;
            /**
             * Conditions for the current state of the Stack.
             */
            conditions?: pulumi.Input<pulumi.Input<inputs.authzed.v1alpha1.SpiceDBClusterStatusConditions>[]>;
            /**
             ...
             * is fully migrated.
             */
            currentMigrationHash?: pulumi.Input<string>;
            /**
             ...
             */
            targetMigrationHash?: pulumi.Input<string>;
            version?: pulumi.Input<inputs.authzed.v1alpha1.SpiceDBClusterStatusVersion>;
        }
