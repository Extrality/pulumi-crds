...
export declare namespace authzed {
    namespace v1alpha1 {
        ...
        interface SpiceDBCluster {
            ...
            spec: outputs.authzed.v1alpha1.SpiceDBClusterSpec;
            status: outputs.authzed.v1alpha1.SpiceDBClusterStatus;
        }
        /**
        ...
        interface SpiceDBClusterSpec {
             ...
             */
            patches: outputs.authzed.v1alpha1.SpiceDBClusterSpecPatches[];
            /**
        ...
        interface SpiceDBClusterSpecPatch {
             ...
             * in the list take precedence over earlier ones.
             */
            patches: outputs.authzed.v1alpha1.SpiceDBClusterSpecPatchesPatch[];
            /**
             * SecretName points to a secret (in the same namespace) that holds secret
             * config for the cluster like passwords, credentials, etc.
             * If the secret is omitted, one will be generated
         ...
         */
        interface SpiceDBClusterSpecPatches {
            /**
         ...
         * Patch represents a single change to apply to generated manifests
         */
        interface SpiceDBClusterSpecPatchesPatch {
            /**
             * Kind targets an object by its kubernetes Kind name.
             */
            kind: string;
         ...
         */
        interface SpiceDBClusterStatus {
            /**
             ...
             */
            availableVersions: outputs.authzed.v1alpha1.SpiceDBClusterStatusAvailableVersions[];
            /**
             * Conditions for the current state of the Stack.
             */
            conditions: outputs.authzed.v1alpha1.SpiceDBClusterStatusConditions[];
            /**
            ...
            version: outputs.authzed.v1alpha1.SpiceDBClusterStatusVersion;
        }
        interface SpiceDBClusterStatusAvailableVersions {
            /**
        ...
        interface SpiceDBClusterStatusAvailableVersionsPatch {
            /**
             * Attributes is an optional set of descriptors for the update, which
             * carry additional information like whether there will be a migration
             * if this version is selected.
         ...
         */
        interface SpiceDBClusterStatusConditions {
            /**
         ...
         * Condition contains details for one aspect of the current state of this API Resource.
         */
        interface SpiceDBClusterStatusConditionsPatch {
            /**
             * lastTransitionTime is the last time the condition transitioned from one status to another.
             * This should be when the underlying condition changed.  If that is not known, then using the time when the API field changed is acceptable.
             */
         ...
         * ClusterStatus communicates the observed state of the cluster.
         */
        interface SpiceDBClusterStatusPatch {
            /**
             * AvailableVersions is a list of versions that the currently running
             * version can be updated to. Only applies if using an update channel.
             */
            availableVersions: outputs.authzed.v1alpha1.SpiceDBClusterStatusAvailableVersionsPatch[];
            /**
             * Conditions for the current state of the Stack.
             */
            conditions: outputs.authzed.v1alpha1.SpiceDBClusterStatusConditionsPatch[];
            /**
             * CurrentMigrationHash is a hash of the currently running migration target and config.
             * If this is equal to TargetMigrationHash (and there are no conditions) then the datastore
             * is fully migrated.
         ...
         * the channel, if an update channel is being used.
         */
        interface SpiceDBClusterStatusVersionPatch {
            /**
             * Attributes is an optional set of descriptors for the update, which
             * carry additional information like whether there will be a migration
             * if this version is selected.
