...
export class TLSRoutePatch extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.gateway.v1.TLSRouteSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.gateway.v1.TLSRouteStatusPatch>;
