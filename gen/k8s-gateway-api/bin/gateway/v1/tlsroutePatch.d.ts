...
export declare class TLSRoutePatch extends pulumi.CustomResource {
    ...
    readonly spec: pulumi.Output<outputs.gateway.v1.TLSRouteSpecPatch>;
    readonly status: pulumi.Output<outputs.gateway.v1.TLSRouteStatusPatch>;
    /**
...
export interface TLSRoutePatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1.TLSRouteSpecPatch>;
}
