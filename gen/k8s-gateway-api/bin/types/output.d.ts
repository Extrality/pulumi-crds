...
export declare namespace gateway {
    namespace v1 {
         ...
         */
        interface BackendTLSPolicySpec {
            /**
         ...
         * Spec defines the desired state of BackendTLSPolicy.
         */
        interface BackendTLSPolicySpecPatch {
            /**
             * Options are a list of key/value pairs to enable extended TLS
             * configuration for each implementation. For example, configuring the
             * minimum TLS version or supported cipher suites.
         ...
         */
        interface BackendTLSPolicySpecTargetRefs {
            /**
         ...
         * LocalPolicyTargetReference should be used.
         */
        interface BackendTLSPolicySpecTargetRefsPatch {
            /**
             * Group is the group of the target resource.
             */
            group: string;
         ...
         */
        interface BackendTLSPolicySpecValidation {
            /**
         ...
         */
        interface BackendTLSPolicySpecValidationCaCertificateRefs {
            /**
         ...
         * on the containing object.
         */
        interface BackendTLSPolicySpecValidationCaCertificateRefsPatch {
            /**
             * Group is the group of the referent. For example, "gateway.networking.k8s.io".
             * When unspecified or empty string, core API group is inferred.
             */
         ...
         * Validation contains backend TLS validation configuration.
         */
        interface BackendTLSPolicySpecValidationPatch {
            /**
             * CACertificateRefs contains one or more references to Kubernetes objects that
             * contain a PEM-encoded TLS CA certificate bundle, which is used to
             * validate a TLS handshake between the Gateway and backend Pod.
         ...
         */
        interface BackendTLSPolicySpecValidationSubjectAltNames {
            /**
         ...
         * SubjectAltName represents Subject Alternative Name.
         */
        interface BackendTLSPolicySpecValidationSubjectAltNamesPatch {
            /**
             * Hostname contains Subject Alternative Name specified in DNS name format.
             * Required when Type is set to Hostname, ignored otherwise.
             *
         ...
         */
        interface BackendTLSPolicyStatus {
            /**
         ...
         */
        interface BackendTLSPolicyStatusAncestors {
         ...
         */
        interface BackendTLSPolicyStatusAncestorsAncestorRef {
            /**
         ...
         * PolicyAncestorStatus struct describes the status of.
         */
        interface BackendTLSPolicyStatusAncestorsAncestorRefPatch {
            /**
             * Group is the group of the referent.
             * When unspecified, "gateway.networking.k8s.io" is inferred.
             * To set the core API group (such as for a "Service" kind referent),
         ...
         */
        interface BackendTLSPolicyStatusAncestorsConditions {
            /**
         ...
         * Condition contains details for one aspect of the current state of this API Resource.
         */
        interface BackendTLSPolicyStatusAncestorsConditionsPatch {
            /**
             * lastTransitionTime is the last time the condition transitioned from one status to another.
             * This should be when the underlying condition changed.  If that is not known, then using the time when the API field changed is acceptable.
             */
         ...
         * with a composite key made up of the AncestorRef and the ControllerName.
         */
        interface BackendTLSPolicyStatusAncestorsPatch {
         ...
         * Status defines the current state of BackendTLSPolicy.
         */
        interface BackendTLSPolicyStatusPatch {
            /**
             * Ancestors is a list of ancestor resources (usually Gateways) that are
             * associated with the policy, and the status of the policy with respect to
             * each ancestor. When this policy attaches to a parent, the controller that
        ...
        interface GRPCRouteSpecRulesBackendRefsFiltersRequestMirror {
            ...
            fraction: outputs.gateway.v1.GRPCRouteSpecRulesBackendRefsFiltersRequestMirrorFraction;
            /**
         ...
         * is specified, 100% of requests will be mirrored.
         */
        interface GRPCRouteSpecRulesBackendRefsFiltersRequestMirrorFraction {
            denominator: number;
            numerator: number;
        }
        /**
         ...
         * is specified, 100% of requests will be mirrored.
         */
        interface GRPCRouteSpecRulesBackendRefsFiltersRequestMirrorFractionPatch {
            denominator: number;
            numerator: number;
        }
        /**
        ...
        interface GRPCRouteSpecRulesBackendRefsFiltersRequestMirrorPatch {
            ...
            fraction: outputs.gateway.v1.GRPCRouteSpecRulesBackendRefsFiltersRequestMirrorFractionPatch;
            /**
             * Percent represents the percentage of requests that should be
             * mirrored to BackendRef. Its minimum value is 0 (indicating 0% of
             * requests) and its maximum value is 100 (indicating 100% of requests).
        ...
        interface GRPCRouteSpecRulesFiltersRequestMirror {
            ...
            fraction: outputs.gateway.v1.GRPCRouteSpecRulesFiltersRequestMirrorFraction;
            /**
             * Percent represents the percentage of requests that should be
             * mirrored to BackendRef. Its minimum value is 0 (indicating 0% of
             * requests) and its maximum value is 100 (indicating 100% of requests).
         ...
         * is specified, 100% of requests will be mirrored.
         */
        interface GRPCRouteSpecRulesFiltersRequestMirrorFraction {
            denominator: number;
            numerator: number;
        }
        /**
         ...
         * is specified, 100% of requests will be mirrored.
         */
        interface GRPCRouteSpecRulesFiltersRequestMirrorFractionPatch {
            denominator: number;
            numerator: number;
        }
        /**
        ...
        interface GRPCRouteSpecRulesFiltersRequestMirrorPatch {
            ...
            fraction: outputs.gateway.v1.GRPCRouteSpecRulesFiltersRequestMirrorFractionPatch;
            /**
             * Percent represents the percentage of requests that should be
             * mirrored to BackendRef. Its minimum value is 0 (indicating 0% of
             * requests) and its maximum value is 100 (indicating 100% of requests).
         ...
         * Condition contains details for one aspect of the current state of this API Resource.
         */
        interface GRPCRouteStatusParentsConditionsPatch {
            /**
             * lastTransitionTime is the last time the condition transitioned from one status to another.
             * This should be when the underlying condition changed.  If that is not known, then using the time when the API field changed is acceptable.
             */
         ...
         * RouteParentStatus struct describes the status of.
         */
        interface GRPCRouteStatusParentsParentRefPatch {
            /**
             * Group is the group of the referent.
             * When unspecified, "gateway.networking.k8s.io" is inferred.
             * To set the core API group (such as for a "Service" kind referent),
         ...
         * associated Parent.
         */
        interface GRPCRouteStatusParentsPatch {
            /**
             * Conditions describes the status of the route with respect to the Gateway.
             * Note that the route's availability is also subject to the Gateway's own
             * status conditions and listener status.
         ...
         * Status defines the current state of GRPCRoute.
         */
        interface GRPCRouteStatusPatch {
            /**
             * Parents is a list of parent resources (usually Gateways) that are
             * associated with the route, and the status of the route with respect to
             * each parent. When this route attaches to a parent, the controller that
        ...
        interface GatewayClassStatus {
             ...
             */
            supportedFeatures: outputs.gateway.v1.GatewayClassStatusSupportedFeatures[];
        }
        /**
         * Condition contains details for one aspect of the current state of this API Resource.
         */
         ...
         * Condition contains details for one aspect of the current state of this API Resource.
         */
        interface GatewayClassStatusConditionsPatch {
            /**
             * lastTransitionTime is the last time the condition transitioned from one status to another.
             * This should be when the underlying condition changed.  If that is not known, then using the time when the API field changed is acceptable.
             */
         ...
         * specify their controller name.
         */
        interface GatewayClassStatusPatch {
            /**
             * Conditions is the current status from the controller for
             * this GatewayClass.
             *
             ...
             * It MUST be sorted in ascending alphabetical order by the Name key.
             */
            supportedFeatures: outputs.gateway.v1.GatewayClassStatusSupportedFeaturesPatch[];
        }
        interface GatewayClassStatusSupportedFeatures {
            /**
        ...
        interface GatewayClassStatusSupportedFeaturesPatch {
            /**
             * FeatureName is used to describe distinct features that are covered by
             * conformance tests.
             */
         ...
         * GatewayStatusAddress describes a network address that is bound to a Gateway.
         */
        interface GatewayStatusAddressesPatch {
            /**
             * Type of the address.
             */
            type: string;
         ...
         * Condition contains details for one aspect of the current state of this API Resource.
         */
        interface GatewayStatusConditionsPatch {
            /**
             * lastTransitionTime is the last time the condition transitioned from one status to another.
             * This should be when the underlying condition changed.  If that is not known, then using the time when the API field changed is acceptable.
             */
         ...
         * Condition contains details for one aspect of the current state of this API Resource.
         */
        interface GatewayStatusListenersConditionsPatch {
            /**
             * lastTransitionTime is the last time the condition transitioned from one status to another.
             * This should be when the underlying condition changed.  If that is not known, then using the time when the API field changed is acceptable.
             */
         ...
         * ListenerStatus is the status associated with a Listener.
         */
        interface GatewayStatusListenersPatch {
            /**
             * AttachedRoutes represents the total number of Routes that have been
             * successfully attached to this Listener.
             *
         ...
         * RouteGroupKind indicates the group and kind of a Route resource.
         */
        interface GatewayStatusListenersSupportedKindsPatch {
            /**
             * Group is the group of the Route.
             */
            group: string;
        ...
        interface HTTPRouteSpecRulesBackendRefsFiltersRequestMirror {
            ...
            fraction: outputs.gateway.v1.HTTPRouteSpecRulesBackendRefsFiltersRequestMirrorFraction;
            /**
             * Percent represents the percentage of requests that should be
             * mirrored to BackendRef. Its minimum value is 0 (indicating 0% of
             * requests) and its maximum value is 100 (indicating 100% of requests).
         ...
         * is specified, 100% of requests will be mirrored.
         */
        interface HTTPRouteSpecRulesBackendRefsFiltersRequestMirrorFraction {
            denominator: number;
            numerator: number;
        }
        /**
         ...
         * is specified, 100% of requests will be mirrored.
         */
        interface HTTPRouteSpecRulesBackendRefsFiltersRequestMirrorFractionPatch {
            denominator: number;
            numerator: number;
        }
        /**
        ...
        interface HTTPRouteSpecRulesBackendRefsFiltersRequestMirrorPatch {
            ...
            fraction: outputs.gateway.v1.HTTPRouteSpecRulesBackendRefsFiltersRequestMirrorFractionPatch;
            /**
             * Percent represents the percentage of requests that should be
             * mirrored to BackendRef. Its minimum value is 0 (indicating 0% of
             * requests) and its maximum value is 100 (indicating 100% of requests).
        ...
        interface HTTPRouteSpecRulesFiltersRequestMirror {
            ...
            fraction: outputs.gateway.v1.HTTPRouteSpecRulesFiltersRequestMirrorFraction;
            /**
             * Percent represents the percentage of requests that should be
             * mirrored to BackendRef. Its minimum value is 0 (indicating 0% of
             * requests) and its maximum value is 100 (indicating 100% of requests).
         ...
         * is specified, 100% of requests will be mirrored.
         */
        interface HTTPRouteSpecRulesFiltersRequestMirrorFraction {
            denominator: number;
            numerator: number;
        }
        /**
         ...
         * is specified, 100% of requests will be mirrored.
         */
        interface HTTPRouteSpecRulesFiltersRequestMirrorFractionPatch {
            denominator: number;
            numerator: number;
        }
        /**
        ...
        interface HTTPRouteSpecRulesFiltersRequestMirrorPatch {
            ...
            fraction: outputs.gateway.v1.HTTPRouteSpecRulesFiltersRequestMirrorFractionPatch;
            /**
             * Percent represents the percentage of requests that should be
             * mirrored to BackendRef. Its minimum value is 0 (indicating 0% of
             * requests) and its maximum value is 100 (indicating 100% of requests).
         ...
         * Condition contains details for one aspect of the current state of this API Resource.
         */
        interface HTTPRouteStatusParentsConditionsPatch {
            /**
             * lastTransitionTime is the last time the condition transitioned from one status to another.
             * This should be when the underlying condition changed.  If that is not known, then using the time when the API field changed is acceptable.
             */
         ...
         * RouteParentStatus struct describes the status of.
         */
        interface HTTPRouteStatusParentsParentRefPatch {
            /**
             * Group is the group of the referent.
             * When unspecified, "gateway.networking.k8s.io" is inferred.
             * To set the core API group (such as for a "Service" kind referent),
         ...
         * associated Parent.
         */
        interface HTTPRouteStatusParentsPatch {
            /**
             * Conditions describes the status of the route with respect to the Gateway.
             * Note that the route's availability is also subject to the Gateway's own
             * status conditions and listener status.
         ...
         * Status defines the current state of HTTPRoute.
         */
        interface HTTPRouteStatusPatch {
            /**
             * Parents is a list of parent resources (usually Gateways) that are
             * associated with the route, and the status of the route with respect to
             * each parent. When this route attaches to a parent, the controller that
    ...
    namespace v1alpha3 {
        ...
        interface BackendTLSPolicy {
             ...
             */
            metadata: outputs.meta.v1.ObjectMeta;
            spec: outputs.gateway.v1alpha3.BackendTLSPolicySpec;
            status: outputs.gateway.v1alpha3.BackendTLSPolicyStatus;
        }
        /**
         * Spec defines the desired state of BackendTLSPolicy.
         */
         ...
         */
        interface BackendTLSPolicyStatusAncestorsPatch {
            ancestorRef: outputs.gateway.v1alpha3.BackendTLSPolicyStatusAncestorsAncestorRefPatch;
            /**
             * Conditions describes the status of the Policy with respect to the given Ancestor.
             */
            conditions: outputs.gateway.v1alpha3.BackendTLSPolicyStatusAncestorsConditionsPatch[];
            /**
             * ControllerName is a domain/path string that indicates the name of the
             * controller that wrote this status. This corresponds with the
             * controllerName field on GatewayClass.
    ...
    namespace v1beta1 {
        ...
        interface GatewayClassStatus {
             ...
             * It MUST be sorted in ascending alphabetical order by the Name key.
             */
            supportedFeatures: outputs.gateway.v1beta1.GatewayClassStatusSupportedFeatures[];
        }
        /**
         * Condition contains details for one aspect of the current state of this API Resource.
         */
        ...
        interface GatewayClassStatusPatch {
             ...
             * It MUST be sorted in ascending alphabetical order by the Name key.
             */
            supportedFeatures: outputs.gateway.v1beta1.GatewayClassStatusSupportedFeaturesPatch[];
        }
        interface GatewayClassStatusSupportedFeatures {
            /**
             * FeatureName is used to describe distinct features that are covered by
        ...
        interface HTTPRouteSpecRulesFiltersRequestMirror {
            ...
            fraction: outputs.gateway.v1beta1.HTTPRouteSpecRulesFiltersRequestMirrorFraction;
            /**
             * Percent represents the percentage of requests that should be
             * mirrored to BackendRef. Its minimum value is 0 (indicating 0% of
             * requests) and its maximum value is 100 (indicating 100% of requests).
