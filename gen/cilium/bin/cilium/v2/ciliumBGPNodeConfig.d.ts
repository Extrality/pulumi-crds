...
export declare class CiliumBGPNodeConfig extends pulumi.CustomResource {
    ...
    readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigSpec>;
    readonly status: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigStatus>;
    /**
...
export interface CiliumBGPNodeConfigArgs {
    ...
    spec?: pulumi.Input<inputs.cilium.v2.CiliumBGPNodeConfigSpec | undefined>;
}
//# sourceMappingURL=ciliumBGPNodeConfig.d.ts.map