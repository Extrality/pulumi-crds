...
export declare class CiliumBGPNodeConfigOverridePatch extends pulumi.CustomResource {
    ...
    readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigOverrideSpecPatch>;
    /**
...
export interface CiliumBGPNodeConfigOverridePatchArgs {
    ...
    spec?: pulumi.Input<inputs.cilium.v2.CiliumBGPNodeConfigOverrideSpecPatch | undefined>;
}
