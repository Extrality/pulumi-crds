 ...
 */
export declare class CiliumBGPClusterConfigPatch extends pulumi.CustomResource {
    /**
     ...
     */
    static isInstance(obj: any): obj is CiliumBGPClusterConfigPatch;
    /**
    ...
    readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPClusterConfigSpecPatch>;
    readonly status: pulumi.Output<outputs.cilium.v2.CiliumBGPClusterConfigStatusPatch>;
    /**
     ...
     */
    constructor(name: string, args?: CiliumBGPClusterConfigPatchArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * The set of arguments for constructing a CiliumBGPClusterConfigPatch resource.
 */
export interface CiliumBGPClusterConfigPatchArgs {
    /**
     * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
     */
    ...
    spec?: pulumi.Input<inputs.cilium.v2.CiliumBGPClusterConfigSpecPatch | undefined>;
}
//# sourceMappingURL=ciliumBGPClusterConfigPatch.d.ts.map