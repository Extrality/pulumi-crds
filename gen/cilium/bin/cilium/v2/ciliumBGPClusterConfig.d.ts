...
export declare class CiliumBGPClusterConfig extends pulumi.CustomResource {
    ...
    readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPClusterConfigSpec>;
    readonly status: pulumi.Output<outputs.cilium.v2.CiliumBGPClusterConfigStatus>;
    /**
...
export interface CiliumBGPClusterConfigArgs {
    ...
    spec?: pulumi.Input<inputs.cilium.v2.CiliumBGPClusterConfigSpec | undefined>;
}
