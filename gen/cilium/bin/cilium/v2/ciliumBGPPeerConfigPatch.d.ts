...
export declare class CiliumBGPPeerConfigPatch extends pulumi.CustomResource {
    ...
    readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPPeerConfigSpecPatch>;
    readonly status: pulumi.Output<outputs.cilium.v2.CiliumBGPPeerConfigStatusPatch>;
    /**
...
export interface CiliumBGPPeerConfigPatchArgs {
    ...
    spec?: pulumi.Input<inputs.cilium.v2.CiliumBGPPeerConfigSpecPatch | undefined>;
}
//# sourceMappingURL=ciliumBGPPeerConfigPatch.d.ts.map