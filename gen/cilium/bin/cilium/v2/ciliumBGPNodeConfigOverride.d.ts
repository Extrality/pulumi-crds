...
export declare class CiliumBGPNodeConfigOverride extends pulumi.CustomResource {
    ...
    readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigOverrideSpec>;
    /**
...
export interface CiliumBGPNodeConfigOverrideArgs {
    ...
    spec?: pulumi.Input<inputs.cilium.v2.CiliumBGPNodeConfigOverrideSpec | undefined>;
}
//# sourceMappingURL=ciliumBGPNodeConfigOverride.d.ts.map