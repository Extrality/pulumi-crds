...
export declare class CiliumBGPNodeConfigList extends pulumi.CustomResource {
     ...
     */
    readonly items: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfig[]>;
    /**
...
export interface CiliumBGPNodeConfigListArgs {
     ...
     * List of ciliumbgpnodeconfigs. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
     */
    items: pulumi.Input<pulumi.Input<inputs.cilium.v2.CiliumBGPNodeConfig>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"CiliumBGPNodeConfigList" | undefined>;
    /**
     * Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    metadata?: pulumi.Input<inputs.meta.v1.ListMeta | undefined>;
}
//# sourceMappingURL=ciliumBGPNodeConfigList.d.ts.map