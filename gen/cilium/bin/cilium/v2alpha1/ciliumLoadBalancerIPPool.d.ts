...
export declare class CiliumLoadBalancerIPPool extends pulumi.CustomResource {
    ...
    readonly spec: pulumi.Output<outputs.cilium.v2alpha1.CiliumLoadBalancerIPPoolSpec>;
    readonly status: pulumi.Output<outputs.cilium.v2alpha1.CiliumLoadBalancerIPPoolStatus>;
    /**
...
export interface CiliumLoadBalancerIPPoolArgs {
    ...
    spec?: pulumi.Input<inputs.cilium.v2alpha1.CiliumLoadBalancerIPPoolSpec | undefined>;
}
