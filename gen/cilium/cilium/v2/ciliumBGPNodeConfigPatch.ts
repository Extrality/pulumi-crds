 ...
 */
export class CiliumBGPNodeConfigPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumBGPNodeConfigPatch {
        return new CiliumBGPNodeConfigPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumBGPNodeConfigPatch';

    /**
     * Returns true if the given object is an instance of CiliumBGPNodeConfigPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CiliumBGPNodeConfigPatch {
     ...
     */
    declare public readonly kind: pulumi.Output<"CiliumBGPNodeConfig">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigStatusPatch>;
    ...
    constructor(name: string, args?: CiliumBGPNodeConfigPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:cilium.io/v2alpha1:CiliumBGPNodeConfigPatch" }] };
