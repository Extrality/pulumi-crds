...
export class CiliumBGPAdvertisement extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumBGPAdvertisement';
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPAdvertisementSpec>;
