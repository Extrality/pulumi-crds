...
export class CiliumBGPNodeConfigOverrideList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumBGPNodeConfigOverrideList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigOverride[]>;
    /**
