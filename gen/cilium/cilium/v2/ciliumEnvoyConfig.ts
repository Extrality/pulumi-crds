...
export class CiliumEnvoyConfig extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumEnvoyConfig {
        return new CiliumEnvoyConfig(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumEnvoyConfig';

    /**
     * Returns true if the given object is an instance of CiliumEnvoyConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CiliumEnvoyConfig {
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumEnvoyConfigSpec>;
