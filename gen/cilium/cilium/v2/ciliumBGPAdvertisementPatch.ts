...
export class CiliumBGPAdvertisementPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumBGPAdvertisementPatch';
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPAdvertisementSpecPatch>;
