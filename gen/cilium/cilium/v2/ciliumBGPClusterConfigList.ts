...
export class CiliumBGPClusterConfigList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumBGPClusterConfigList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.cilium.v2.CiliumBGPClusterConfig[]>;
    /**
