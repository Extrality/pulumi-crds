 ...
 */
export class CiliumBGPNodeConfigOverridePatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumBGPNodeConfigOverridePatch {
        return new CiliumBGPNodeConfigOverridePatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumBGPNodeConfigOverridePatch';
     ...
     */
    public static isInstance(obj: any): obj is CiliumBGPNodeConfigOverridePatch {
     ...
     */
    declare public readonly kind: pulumi.Output<"CiliumBGPNodeConfigOverride">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigOverrideSpecPatch>;
    ...
    constructor(name: string, args?: CiliumBGPNodeConfigOverridePatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:cilium.io/v2alpha1:CiliumBGPNodeConfigOverridePatch" }] };
