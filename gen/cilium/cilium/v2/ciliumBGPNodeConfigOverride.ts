...
export class CiliumBGPNodeConfigOverride extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumBGPNodeConfigOverride';
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigOverrideSpec>;
    ...
    constructor(name: string, args?: CiliumBGPNodeConfigOverrideArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:cilium.io/v2alpha1:CiliumBGPNodeConfigOverride" }] };
