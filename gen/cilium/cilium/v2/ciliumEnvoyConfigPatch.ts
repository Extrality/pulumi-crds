 ...
 */
export class CiliumEnvoyConfigPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumEnvoyConfigPatch {
        return new CiliumEnvoyConfigPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumEnvoyConfigPatch';

    /**
     * Returns true if the given object is an instance of CiliumEnvoyConfigPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CiliumEnvoyConfigPatch {
     ...
     */
    declare public readonly kind: pulumi.Output<"CiliumEnvoyConfig">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumEnvoyConfigSpecPatch>;
