...
export class CiliumBGPAdvertisementList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumBGPAdvertisementList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.cilium.v2.CiliumBGPAdvertisement[]>;
    /**
