...
export class CiliumBGPClusterConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumBGPClusterConfig';
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPClusterConfigSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cilium.v2.CiliumBGPClusterConfigStatus>;
    ...
    constructor(name: string, args?: CiliumBGPClusterConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:cilium.io/v2alpha1:CiliumBGPClusterConfig" }] };
