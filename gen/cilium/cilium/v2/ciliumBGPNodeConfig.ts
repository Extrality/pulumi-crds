...
export class CiliumBGPNodeConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumBGPNodeConfig';
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cilium.v2.CiliumBGPNodeConfigStatus>;
