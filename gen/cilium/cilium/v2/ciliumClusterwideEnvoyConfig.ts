...
export class CiliumClusterwideEnvoyConfig extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumClusterwideEnvoyConfig {
        return new CiliumClusterwideEnvoyConfig(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumClusterwideEnvoyConfig';
     ...
     */
    public static isInstance(obj: any): obj is CiliumClusterwideEnvoyConfig {
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumClusterwideEnvoyConfigSpec>;
