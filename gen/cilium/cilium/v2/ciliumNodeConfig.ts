 ...
 */
export class CiliumNodeConfig extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumNodeConfig {
        return new CiliumNodeConfig(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumNodeConfig';

    /**
     * Returns true if the given object is an instance of CiliumNodeConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CiliumNodeConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CiliumNodeConfig.__pulumiType;
    }
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumNodeConfigSpec>;
    ...
    constructor(name: string, args?: CiliumNodeConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CiliumNodeConfig.__pulumiType, name, resourceInputs, opts);
    }
}
