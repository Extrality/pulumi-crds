...
export class CiliumEgressGatewayPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumEgressGatewayPolicy {
        return new CiliumEgressGatewayPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumEgressGatewayPolicy';
     ...
     */
    public static isInstance(obj: any): obj is CiliumEgressGatewayPolicy {
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumEgressGatewayPolicySpec>;
