 ...
 */
export class CiliumEgressGatewayPolicyList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumEgressGatewayPolicyList {
        return new CiliumEgressGatewayPolicyList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumEgressGatewayPolicyList';
     ...
     */
    public static isInstance(obj: any): obj is CiliumEgressGatewayPolicyList {
     ...
     */
    declare public readonly items: pulumi.Output<outputs.cilium.v2.CiliumEgressGatewayPolicy[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"CiliumEgressGatewayPolicyList">;
    /**
