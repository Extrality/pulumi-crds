 ...
 */
export class CiliumNode extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumNode {
        return new CiliumNode(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumNode';

    /**
     * Returns true if the given object is an instance of CiliumNode.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CiliumNode {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CiliumNode.__pulumiType;
    }
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumNodeSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cilium.v2.CiliumNodeStatus>;
    ...
    constructor(name: string, args?: CiliumNodeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CiliumNode.__pulumiType, name, resourceInputs, opts);
    }
}
