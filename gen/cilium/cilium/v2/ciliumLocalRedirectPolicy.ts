 ...
 */
export class CiliumLocalRedirectPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumLocalRedirectPolicy {
        return new CiliumLocalRedirectPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2:CiliumLocalRedirectPolicy';
     ...
     */
    public static isInstance(obj: any): obj is CiliumLocalRedirectPolicy {
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2.CiliumLocalRedirectPolicySpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cilium.v2.CiliumLocalRedirectPolicyStatus>;
