 ...
 * L2 network.
 */
export class CiliumL2AnnouncementPolicyPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumL2AnnouncementPolicyPatch {
        return new CiliumL2AnnouncementPolicyPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumL2AnnouncementPolicyPatch';
     ...
     */
    public static isInstance(obj: any): obj is CiliumL2AnnouncementPolicyPatch {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CiliumL2AnnouncementPolicyPatch.__pulumiType;
    }
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2alpha1.CiliumL2AnnouncementPolicySpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cilium.v2alpha1.CiliumL2AnnouncementPolicyStatusPatch>;
    ...
    constructor(name: string, args?: CiliumL2AnnouncementPolicyPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CiliumL2AnnouncementPolicyPatch.__pulumiType, name, resourceInputs, opts);
    }
}
