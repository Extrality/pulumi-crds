 ...
 */
export class CiliumBGPNodeConfig extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumBGPNodeConfig {
        return new CiliumBGPNodeConfig(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumBGPNodeConfig';

    /**
     * Returns true if the given object is an instance of CiliumBGPNodeConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CiliumBGPNodeConfig {
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPNodeConfigSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPNodeConfigStatus>;
    ...
    constructor(name: string, args?: CiliumBGPNodeConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:cilium.io/v2:CiliumBGPNodeConfig" }] };
