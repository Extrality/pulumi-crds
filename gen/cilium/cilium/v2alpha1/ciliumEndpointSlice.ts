 ...
 */
export class CiliumEndpointSlice extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumEndpointSlice {
        return new CiliumEndpointSlice(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumEndpointSlice';

    /**
     * Returns true if the given object is an instance of CiliumEndpointSlice.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CiliumEndpointSlice {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CiliumEndpointSlice.__pulumiType;
    }
     ...
     */
    declare public readonly endpoints: pulumi.Output<outputs.cilium.v2alpha1.CiliumEndpointSliceEndpoints[]>;
    /**
    ...
    constructor(name: string, args?: CiliumEndpointSliceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CiliumEndpointSlice.__pulumiType, name, resourceInputs, opts);
    }
}
