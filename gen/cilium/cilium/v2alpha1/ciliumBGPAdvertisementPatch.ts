 ...
 */
export class CiliumBGPAdvertisementPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumBGPAdvertisementPatch {
        return new CiliumBGPAdvertisementPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumBGPAdvertisementPatch';
     ...
     */
    public static isInstance(obj: any): obj is CiliumBGPAdvertisementPatch {
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPAdvertisementSpecPatch>;
    ...
    constructor(name: string, args?: CiliumBGPAdvertisementPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:cilium.io/v2:CiliumBGPAdvertisementPatch" }] };
