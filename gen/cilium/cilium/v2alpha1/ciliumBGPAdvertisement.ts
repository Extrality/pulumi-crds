 ...
 */
export class CiliumBGPAdvertisement extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumBGPAdvertisement {
        return new CiliumBGPAdvertisement(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumBGPAdvertisement';

    /**
     * Returns true if the given object is an instance of CiliumBGPAdvertisement.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CiliumBGPAdvertisement {
     ...
     */
    declare public readonly kind: pulumi.Output<"CiliumBGPAdvertisement">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMeta>;
    declare public readonly spec: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPAdvertisementSpec>;
    ...
    constructor(name: string, args?: CiliumBGPAdvertisementArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:cilium.io/v2:CiliumBGPAdvertisement" }] };
