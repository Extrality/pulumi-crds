 ...
 */
export class CiliumBGPNodeConfigOverride extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumBGPNodeConfigOverride {
        return new CiliumBGPNodeConfigOverride(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumBGPNodeConfigOverride';
     ...
     */
    public static isInstance(obj: any): obj is CiliumBGPNodeConfigOverride {
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPNodeConfigOverrideSpec>;
    ...
    constructor(name: string, args?: CiliumBGPNodeConfigOverrideArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:cilium.io/v2:CiliumBGPNodeConfigOverride" }] };
