...
export class CiliumBGPNodeConfigPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumBGPNodeConfigPatch';
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPNodeConfigSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPNodeConfigStatusPatch>;
    ...
    constructor(name: string, args?: CiliumBGPNodeConfigPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:cilium.io/v2:CiliumBGPNodeConfigPatch" }] };
