...
export class CiliumBGPPeerConfigList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumBGPPeerConfigList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPPeerConfig[]>;
    /**
