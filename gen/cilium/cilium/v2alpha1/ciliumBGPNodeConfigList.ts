...
export class CiliumBGPNodeConfigList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumBGPNodeConfigList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPNodeConfig[]>;
    /**
