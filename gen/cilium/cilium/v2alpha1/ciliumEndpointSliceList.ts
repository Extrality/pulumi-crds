 ...
 */
export class CiliumEndpointSliceList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumEndpointSliceList {
        return new CiliumEndpointSliceList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumEndpointSliceList';

    /**
     * Returns true if the given object is an instance of CiliumEndpointSliceList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CiliumEndpointSliceList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CiliumEndpointSliceList.__pulumiType;
    }
     ...
     */
    declare public readonly items: pulumi.Output<outputs.cilium.v2alpha1.CiliumEndpointSlice[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"CiliumEndpointSliceList">;
    /**
    ...
    constructor(name: string, args?: CiliumEndpointSliceListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "CiliumEndpointSliceList";
        ...
        super(CiliumEndpointSliceList.__pulumiType, name, resourceInputs, opts);
    }
}
