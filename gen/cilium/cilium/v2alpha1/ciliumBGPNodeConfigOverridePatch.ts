...
export class CiliumBGPNodeConfigOverridePatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumBGPNodeConfigOverridePatch';
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPNodeConfigOverrideSpecPatch>;
    ...
    constructor(name: string, args?: CiliumBGPNodeConfigOverridePatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:cilium.io/v2:CiliumBGPNodeConfigOverridePatch" }] };
