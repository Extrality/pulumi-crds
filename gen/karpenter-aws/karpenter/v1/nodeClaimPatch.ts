...
export class NodeClaimPatch extends pulumi.CustomResource {
     ...
     */
    public readonly kind!: pulumi.Output<"NodeClaim">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    public readonly metadata!: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    public readonly spec!: pulumi.Output<outputs.karpenter.v1.NodeClaimSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.karpenter.v1.NodeClaimStatusPatch>;
