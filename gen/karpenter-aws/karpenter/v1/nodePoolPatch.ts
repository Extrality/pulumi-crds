...
export class NodePoolPatch extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.karpenter.v1.NodePoolSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.karpenter.v1.NodePoolStatusPatch>;
