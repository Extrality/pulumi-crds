 ...
 */
export class NodeOverlayList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NodeOverlayList {
        return new NodeOverlayList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:karpenter.sh/v1alpha1:NodeOverlayList';

    /**
     * Returns true if the given object is an instance of NodeOverlayList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NodeOverlayList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NodeOverlayList.__pulumiType;
    }
     ...
     */
    declare public readonly items: pulumi.Output<outputs.karpenter.v1alpha1.NodeOverlay[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"NodeOverlayList">;
    /**
    ...
    constructor(name: string, args?: NodeOverlayListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "NodeOverlayList";
        ...
        super(NodeOverlayList.__pulumiType, name, resourceInputs, opts);
    }
}
