...
export declare const NodeOverlay: typeof import("./nodeOverlay").NodeOverlay;
export { NodeOverlayListArgs } from "./nodeOverlayList";
export type NodeOverlayList = import("./nodeOverlayList").NodeOverlayList;
export declare const NodeOverlayList: typeof import("./nodeOverlayList").NodeOverlayList;
