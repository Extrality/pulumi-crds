 ...
 */
export declare class NodeClaim extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NodeClaim;
    /**
     * Returns true if the given object is an instance of NodeClaim.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NodeClaim;
    /**
    ...
    readonly spec: pulumi.Output<outputs.karpenter.v1.NodeClaimSpec>;
    readonly status: pulumi.Output<outputs.karpenter.v1.NodeClaimStatus>;
    /**
...
//# sourceMappingURL=nodeClaim.d.ts.map