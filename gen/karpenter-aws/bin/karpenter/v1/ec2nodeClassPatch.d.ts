 ...
 */
export declare class EC2NodeClassPatch extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EC2NodeClassPatch;
    /**
     * Returns true if the given object is an instance of EC2NodeClassPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EC2NodeClassPatch;
    /**
    ...
    readonly spec: pulumi.Output<outputs.karpenter.v1.EC2NodeClassSpecPatch>;
    readonly status: pulumi.Output<outputs.karpenter.v1.EC2NodeClassStatusPatch>;
    /**
...
export interface EC2NodeClassPatchArgs {
    ...
    spec?: pulumi.Input<inputs.karpenter.v1.EC2NodeClassSpecPatch>;
}
