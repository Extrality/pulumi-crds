 ...
 */
export declare class NodeClaimPatch extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NodeClaimPatch;
    /**
     * Returns true if the given object is an instance of NodeClaimPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NodeClaimPatch;
    /**
     ...
     */
    readonly kind: pulumi.Output<"NodeClaim">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    readonly spec: pulumi.Output<outputs.karpenter.v1.NodeClaimSpecPatch>;
    readonly status: pulumi.Output<outputs.karpenter.v1.NodeClaimStatusPatch>;
    /**
...
export interface NodeClaimPatchArgs {
    ...
    spec?: pulumi.Input<inputs.karpenter.v1.NodeClaimSpecPatch>;
}
