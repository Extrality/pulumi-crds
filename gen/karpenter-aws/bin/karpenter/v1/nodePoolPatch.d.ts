 ...
 */
export declare class NodePoolPatch extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NodePoolPatch;
    /**
     * Returns true if the given object is an instance of NodePoolPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NodePoolPatch;
    /**
     ...
     */
    readonly kind: pulumi.Output<"NodePool">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    readonly spec: pulumi.Output<outputs.karpenter.v1.NodePoolSpecPatch>;
    readonly status: pulumi.Output<outputs.karpenter.v1.NodePoolStatusPatch>;
    /**
...
export interface NodePoolPatchArgs {
    ...
    spec?: pulumi.Input<inputs.karpenter.v1.NodePoolSpecPatch>;
}
