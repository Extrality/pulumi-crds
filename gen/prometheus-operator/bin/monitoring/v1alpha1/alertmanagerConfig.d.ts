 ...
 */
export declare class AlertmanagerConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AlertmanagerConfig;
    /**
     * Returns true if the given object is an instance of AlertmanagerConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AlertmanagerConfig;
    /**
     ...
     */
    readonly kind: pulumi.Output<"AlertmanagerConfig">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMeta>;
    readonly spec: pulumi.Output<outputs.monitoring.v1alpha1.AlertmanagerConfigSpec>;
    readonly status: pulumi.Output<outputs.monitoring.v1alpha1.AlertmanagerConfigStatus>;
    /**
...
//# sourceMappingURL=alertmanagerConfig.d.ts.map