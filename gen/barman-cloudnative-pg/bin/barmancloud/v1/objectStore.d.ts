 ...
 */
export declare class ObjectStore extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ObjectStore;
    /**
     * Returns true if the given object is an instance of ObjectStore.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ObjectStore;
    /**
    ...
    readonly spec: pulumi.Output<outputs.barmancloud.v1.ObjectStoreSpec>;
    readonly status: pulumi.Output<outputs.barmancloud.v1.ObjectStoreStatus>;
    /**
