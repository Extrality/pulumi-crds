...
export class ObjectStore extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.barmancloud.v1.ObjectStoreSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.barmancloud.v1.ObjectStoreStatus>;
