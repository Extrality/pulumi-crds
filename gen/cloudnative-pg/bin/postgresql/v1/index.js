    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "kubernetes:postgresql.cnpg.io/v1:DatabaseRole":
                return new exports.DatabaseRole(name, undefined, { urn });
            case "kubernetes:postgresql.cnpg.io/v1:DatabaseRoleList":
                return new exports.DatabaseRoleList(name, undefined, { urn });
            case "kubernetes:postgresql.cnpg.io/v1:DatabaseRolePatch":
                return new exports.DatabaseRolePatch(name, undefined, { urn });
