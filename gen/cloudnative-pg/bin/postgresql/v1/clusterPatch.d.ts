...
export declare class ClusterPatch extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterPatch;
    /**
     * Returns true if the given object is an instance of ClusterPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ClusterPatch;
    /**
    ...
    readonly spec: pulumi.Output<outputs.postgresql.v1.ClusterSpecPatch>;
    readonly status: pulumi.Output<outputs.postgresql.v1.ClusterStatusPatch>;
    /**
...
//# sourceMappingURL=clusterPatch.d.ts.map