...
export declare class Publication extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Publication;
    /**
    ...
    readonly spec: pulumi.Output<outputs.postgresql.v1.PublicationSpec>;
    readonly status: pulumi.Output<outputs.postgresql.v1.PublicationStatus>;
    /**
