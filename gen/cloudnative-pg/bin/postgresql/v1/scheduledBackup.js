...
class ScheduledBackup extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new ScheduledBackup(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ScheduledBackup.__pulumiType = 'kubernetes:postgresql.cnpg.io/v1:ScheduledBackup';
