 ...
 */
export declare class Federation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Federation;
    /**
     * Returns true if the given object is an instance of Federation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Federation;
    /**
    ...
    readonly spec: pulumi.Output<outputs.rabbitmq.v1beta1.FederationSpec>;
    readonly status: pulumi.Output<outputs.rabbitmq.v1beta1.FederationStatus>;
    /**
