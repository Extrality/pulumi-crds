...
export declare class Vhost extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Vhost;
    /**
    ...
    readonly spec: pulumi.Output<outputs.rabbitmq.v1beta1.VhostSpec>;
    readonly status: pulumi.Output<outputs.rabbitmq.v1beta1.VhostStatus>;
    /**
