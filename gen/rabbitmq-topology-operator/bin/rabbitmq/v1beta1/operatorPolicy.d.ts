...
export declare class OperatorPolicy extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OperatorPolicy;
    /**
    ...
    readonly spec: pulumi.Output<outputs.rabbitmq.v1beta1.OperatorPolicySpec>;
    readonly status: pulumi.Output<outputs.rabbitmq.v1beta1.OperatorPolicyStatus>;
    /**
