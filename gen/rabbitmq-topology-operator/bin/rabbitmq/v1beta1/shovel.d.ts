...
export declare class Shovel extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Shovel;
    /**
    ...
    readonly spec: pulumi.Output<outputs.rabbitmq.v1beta1.ShovelSpec>;
    readonly status: pulumi.Output<outputs.rabbitmq.v1beta1.ShovelStatus>;
    /**
