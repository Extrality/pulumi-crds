...
export declare class Exchange extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Exchange;
    /**
     * Returns true if the given object is an instance of Exchange.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Exchange;
    /**
    ...
    readonly spec: pulumi.Output<outputs.rabbitmq.v1beta1.ExchangeSpec>;
    readonly status: pulumi.Output<outputs.rabbitmq.v1beta1.ExchangeStatus>;
    /**
