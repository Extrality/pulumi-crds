...
export class OperatorPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OperatorPolicy {
        return new OperatorPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:rabbitmq.com/v1beta1:OperatorPolicy';
    ...
    public readonly spec!: pulumi.Output<outputs.rabbitmq.v1beta1.OperatorPolicySpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.rabbitmq.v1beta1.OperatorPolicyStatus>;
