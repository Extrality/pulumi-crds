...
export class Federation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:rabbitmq.com/v1beta1:Federation';
    ...
    public readonly spec!: pulumi.Output<outputs.rabbitmq.v1beta1.FederationSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.rabbitmq.v1beta1.FederationStatus>;
