...
export class Exchange extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Exchange {
        return new Exchange(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:rabbitmq.com/v1beta1:Exchange';
    ...
    public readonly spec!: pulumi.Output<outputs.rabbitmq.v1beta1.ExchangeSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.rabbitmq.v1beta1.ExchangeStatus>;
