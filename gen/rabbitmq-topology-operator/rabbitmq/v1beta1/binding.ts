...
export class Binding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:rabbitmq.com/v1beta1:Binding';
    ...
    public readonly spec!: pulumi.Output<outputs.rabbitmq.v1beta1.BindingSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.rabbitmq.v1beta1.BindingStatus>;
