...
export namespace rabbitmq {
    export namespace v1alpha1 {
         ...
         * SuperStreamSpec defines the desired state of SuperStream
         */
        export interface SuperStreamSpecPatch {
            /**
             * Name of the queue; required property.
             */
            name?: pulumi.Input<string>;
         ...
         * Have to set either name or connectionSecret, but not both.
         */
        export interface SuperStreamSpecRabbitmqClusterReferenceConnectionSecretPatch {
            /**
             * Name of the referent.
             * This field is effectively required, but due to backwards compatibility is
             * allowed to be empty. Instances of this type with an empty value here are
         ...
         * Required property.
         */
        export interface SuperStreamSpecRabbitmqClusterReferencePatch {
         ...
         */
        export interface SuperStreamStatus {
        ...
        export interface SuperStreamStatusConditions {
            /**
    ...
    export namespace v1beta1 {
         ...
         * BindingSpec defines the desired state of Binding
         */
        export interface BindingSpecPatch {
            /**
             * Cannot be updated
             */
            arguments?: pulumi.Input<{[key: string]: any}>;
         ...
         * Have to set either name or connectionSecret, but not both.
         */
        export interface BindingSpecRabbitmqClusterReferenceConnectionSecretPatch {
            /**
             * Name of the referent.
             * This field is effectively required, but due to backwards compatibility is
             * allowed to be empty. Instances of this type with an empty value here are
         ...
         * Required property.
         */
        export interface BindingSpecRabbitmqClusterReferencePatch {
        ...
        export interface BindingStatusConditions {
            /**
             * The last time this Condition status changed.
             */
            lastTransitionTime?: pulumi.Input<string>;
         ...
         * ExchangeSpec defines the desired state of Exchange
         */
        export interface ExchangeSpecPatch {
            arguments?: pulumi.Input<{[key: string]: any}>;
            /**
             * Cannot be updated
             */
         ...
         * Have to set either name or connectionSecret, but not both.
         */
        export interface ExchangeSpecRabbitmqClusterReferenceConnectionSecretPatch {
            /**
             * Name of the referent.
             * This field is effectively required, but due to backwards compatibility is
             * allowed to be empty. Instances of this type with an empty value here are
         ...
         * Required property.
         */
        export interface ExchangeSpecRabbitmqClusterReferencePatch {
        ...
        export interface ExchangeStatusConditions {
            /**
             * The last time this Condition status changed.
             */
            lastTransitionTime?: pulumi.Input<string>;
        ...
        export interface FederationSpec {
             ...
             */
            name?: pulumi.Input<string>;
            prefetch-count?: pulumi.Input<number>;
            ...
            rabbitmqClusterReference?: pulumi.Input<inputs.rabbitmq.v1beta1.FederationSpecRabbitmqClusterReference>;
             ...
             */
            resourceCleanupMode?: pulumi.Input<string>;
            trustUserId?: pulumi.Input<boolean>;
            uriSecret?: pulumi.Input<inputs.rabbitmq.v1beta1.FederationSpecUriSecret>;
            /**
             * Default to vhost '/'; cannot be updated
             */
            vhost?: pulumi.Input<string>;
        ...
        export interface FederationSpecPatch {
             ...
             */
            queueType?: pulumi.Input<string>;
            rabbitmqClusterReference?: pulumi.Input<inputs.rabbitmq.v1beta1.FederationSpecRabbitmqClusterReferencePatch>;
            reconnectDelay?: pulumi.Input<number>;
            /**
             * Whether to delete the internal upstream queue when federation links stop.
             * By default, the internal upstream queue is deleted immediately when a federation link stops.
            ...
            resourceCleanupMode?: pulumi.Input<string>;
            trustUserId?: pulumi.Input<boolean>;
            uriSecret?: pulumi.Input<inputs.rabbitmq.v1beta1.FederationSpecUriSecretPatch>;
            /**
             * Default to vhost '/'; cannot be updated
             */
            vhost?: pulumi.Input<string>;
        ...
        export interface ShovelSpec {
             ...
             */
            destApplicationProperties?: pulumi.Input<{[key: string]: any}>;
            /**
             ...
             * amqp10 configuration
             */
            destMessageAnnotations?: pulumi.Input<{[key: string]: any}>;
            /**
             * amqp10 configuration
             */
            destProperties?: pulumi.Input<{[key: string]: any}>;
            destProtocol?: pulumi.Input<string>;
            /**
             * amqp091 configuration
             */
            destPublishProperties?: pulumi.Input<{[key: string]: any}>;
            /**
             * amqp091 configuration
             */
            destQueue?: pulumi.Input<string>;
            destQueueArgs?: pulumi.Input<{[key: string]: any}>;
            /**
             * Required property; cannot be updated
             */
            name?: pulumi.Input<string>;
             ...
             * amqp091 configuration
             */
            srcConsumerArgs?: pulumi.Input<{[key: string]: any}>;
            ...
            srcQueueArgs?: pulumi.Input<{[key: string]: any}>;
