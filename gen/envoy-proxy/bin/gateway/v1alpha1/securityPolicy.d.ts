...
export declare class SecurityPolicy extends pulumi.CustomResource {
    ...
    readonly spec: pulumi.Output<outputs.gateway.v1alpha1.SecurityPolicySpec>;
    readonly status: pulumi.Output<outputs.gateway.v1alpha1.SecurityPolicyStatus>;
    /**
...
export interface SecurityPolicyArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1alpha1.SecurityPolicySpec | undefined>;
}
