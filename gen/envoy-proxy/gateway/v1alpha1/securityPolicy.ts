...
export class SecurityPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.envoyproxy.io/v1alpha1:SecurityPolicy';
    ...
    public readonly spec!: pulumi.Output<outputs.gateway.v1alpha1.SecurityPolicySpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.gateway.v1alpha1.SecurityPolicyStatus>;
