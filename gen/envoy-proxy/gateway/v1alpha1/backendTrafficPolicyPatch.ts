 ...
 */
export class BackendTrafficPolicyPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackendTrafficPolicyPatch {
        return new BackendTrafficPolicyPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.envoyproxy.io/v1alpha1:BackendTrafficPolicyPatch';
     ...
     */
    public static isInstance(obj: any): obj is BackendTrafficPolicyPatch {
     ...
     */
    public readonly kind!: pulumi.Output<"BackendTrafficPolicy">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    public readonly metadata!: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    public readonly spec!: pulumi.Output<outputs.gateway.v1alpha1.BackendTrafficPolicySpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.gateway.v1alpha1.BackendTrafficPolicyStatusPatch>;
