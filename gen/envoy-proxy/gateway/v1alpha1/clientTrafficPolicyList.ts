 ...
 */
export class ClientTrafficPolicyList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClientTrafficPolicyList {
        return new ClientTrafficPolicyList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.envoyproxy.io/v1alpha1:ClientTrafficPolicyList';

    /**
     * Returns true if the given object is an instance of ClientTrafficPolicyList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClientTrafficPolicyList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClientTrafficPolicyList.__pulumiType;
    }
     ...
     */
    public readonly items!: pulumi.Output<outputs.gateway.v1alpha1.ClientTrafficPolicy[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    public readonly kind!: pulumi.Output<"ClientTrafficPolicyList">;
    /**
    ...
    constructor(name: string, args?: ClientTrafficPolicyListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "ClientTrafficPolicyList";
        ...
        super(ClientTrafficPolicyList.__pulumiType, name, resourceInputs, opts);
    }
}
