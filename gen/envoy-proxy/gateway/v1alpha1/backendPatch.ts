 ...
 */
export class BackendPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackendPatch {
        return new BackendPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.envoyproxy.io/v1alpha1:BackendPatch';

    /**
     * Returns true if the given object is an instance of BackendPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BackendPatch {
     ...
     */
    public readonly kind!: pulumi.Output<"Backend">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    public readonly metadata!: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    public readonly spec!: pulumi.Output<outputs.gateway.v1alpha1.BackendSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.gateway.v1alpha1.BackendStatusPatch>;
