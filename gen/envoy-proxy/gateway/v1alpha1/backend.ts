...
export class Backend extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.envoyproxy.io/v1alpha1:Backend';
    ...
    public readonly spec!: pulumi.Output<outputs.gateway.v1alpha1.BackendSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.gateway.v1alpha1.BackendStatus>;
