 ...
 */
export class BackendTrafficPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BackendTrafficPolicy {
        return new BackendTrafficPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.envoyproxy.io/v1alpha1:BackendTrafficPolicy';

    /**
     * Returns true if the given object is an instance of BackendTrafficPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BackendTrafficPolicy {
    ...
    public readonly spec!: pulumi.Output<outputs.gateway.v1alpha1.BackendTrafficPolicySpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.gateway.v1alpha1.BackendTrafficPolicyStatus>;
