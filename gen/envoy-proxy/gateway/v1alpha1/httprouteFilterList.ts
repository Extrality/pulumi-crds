 ...
 */
export class HTTPRouteFilterList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HTTPRouteFilterList {
        return new HTTPRouteFilterList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.envoyproxy.io/v1alpha1:HTTPRouteFilterList';

    /**
     * Returns true if the given object is an instance of HTTPRouteFilterList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HTTPRouteFilterList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HTTPRouteFilterList.__pulumiType;
    }
     ...
     */
    public readonly items!: pulumi.Output<outputs.gateway.v1alpha1.HTTPRouteFilter[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    public readonly kind!: pulumi.Output<"HTTPRouteFilterList">;
    /**
    ...
    constructor(name: string, args?: HTTPRouteFilterListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "HTTPRouteFilterList";
        ...
        super(HTTPRouteFilterList.__pulumiType, name, resourceInputs, opts);
    }
}
